 ...
 */
@Tag(name = "제품", description = "상용 의약품 제품명으로 성분 조회 (공공데이터포털 허가 원본 데이터, 22,000여 종)")
@RestController
...
public class ProductController {
    ...
    @Operation(
            ...
            description = """
                    ...
                    둘 다 실패하면(DB 수집 범위 밖이거나 모호함) 빈 배열을 돌려준다 — 틀린 용량의
                    성분을 잘못 붙이는 것보다 못 찾는 게 낫다는 원칙(TROUBLESHOOTING.md §12·§26·§27).
