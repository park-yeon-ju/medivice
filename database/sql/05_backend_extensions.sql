...
실행 순서
  1) database/sql/01_schema_ddl.sql
  2) database/sql/02_seed_code.sql
  3) database/sql/03_medilight_views.sql
  4) (선택) database/sql/04_demo_scenario.sql — 판정 검증용 샘플 데이터
